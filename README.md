...
[![Tests](https://img.shields.io/badge/tests-1894%20passing-2ea043?logo=pytest&logoColor=white)](#-the-quality-gate)
...
uv run pytest --cov     # 1894 tests + coverage across core + apps
```
