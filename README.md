...
[![Tests](https://img.shields.io/badge/tests-2254%20passing-2ea043?logo=pytest&logoColor=white)](#-the-quality-gate)
...
uv run pytest --cov     # 2254 tests + coverage across core + apps
```
