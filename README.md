...
[![Tests](https://img.shields.io/badge/tests-2445%20passing-2ea043?logo=pytest&logoColor=white)](#-the-quality-gate)
...
uv run pytest --cov     # 2445 tests + coverage across core + apps
```
