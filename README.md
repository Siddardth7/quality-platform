...
[![Tests](https://img.shields.io/badge/tests-1646%20passing-2ea043?logo=pytest&logoColor=white)](#-the-quality-gate)
...
uv run pytest --cov     # 1646 tests + coverage across core + apps
```
