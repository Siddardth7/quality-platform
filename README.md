...
[![Tests](https://img.shields.io/badge/tests-2068%20passing-2ea043?logo=pytest&logoColor=white)](#-the-quality-gate)
...
uv run pytest --cov     # 2068 tests + coverage across core + apps
```
