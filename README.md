...
[![Tests](https://img.shields.io/badge/tests-1767%20passing-2ea043?logo=pytest&logoColor=white)](#-the-quality-gate)
...
uv run pytest --cov     # 1767 tests + coverage across core + apps
```
