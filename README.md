...
[![Tests](https://img.shields.io/badge/tests-2471%20passing-2ea043?logo=pytest&logoColor=white)](#-the-quality-gate)
...
uv run pytest --cov     # 2471 tests + coverage across core + apps
```
