...
[![Tests](https://img.shields.io/badge/tests-1246%20passing-2ea043?logo=pytest&logoColor=white)](#-the-quality-gate)
...
uv run pytest --cov     # 1246 tests + coverage across core + apps
```
...
└── apps/
    ...
    ├── msa/                # MSA / Gage R&R — Average-and-Range + ANOVA
